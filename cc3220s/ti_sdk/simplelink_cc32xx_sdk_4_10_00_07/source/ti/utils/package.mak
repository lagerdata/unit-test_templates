...
package/%.xdc.inc package/%_ti.utils.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.utils" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.utils $@
...
.PHONY: release,ti_utils
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_utils.zip.dep
endif
package/rel/ti_utils/ti/utils/package/package.rel.xml: package/package.bld.xml
package/rel/ti_utils/ti/utils/package/package.rel.xml: package/build.cfg
package/rel/ti_utils/ti/utils/package/package.rel.xml: package/package.xdc.inc
package/rel/ti_utils/ti/utils/package/package.rel.xml: .meta/Common.js
package/rel/ti_utils/ti/utils/package/package.rel.xml: package.bld
package/rel/ti_utils/ti/utils/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/ti_utils/ti/utils/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

../../../exports/ti_utils.zip: package/rel/ti_utils.xdc.inc package/rel/ti_utils/ti/utils/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_utils.xdc.inc,package/rel/ti_utils.zip.dep)


release release,ti_utils: all ../../../exports/ti_utils.zip
clean:: .clean
	-$(RM) package/rel/ti_utils.xdc.inc
	-$(RM) package/rel/ti_utils.zip.dep
